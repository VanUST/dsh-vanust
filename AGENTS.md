...
the twenty-six records under `docs/adrs/` — fifteen decisions in force, one proposed
decision awaiting a human (0026), nine approval records, and the superseded ADR 0007. Two
tools read it —
