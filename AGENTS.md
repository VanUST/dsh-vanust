...
the ten records under `docs/adrs/` — eight decisions in force, the approval that put
two of them into force, and one proposed amendment (0010) that re-binds ADR 0007's
consent laws. Two tools read it —
