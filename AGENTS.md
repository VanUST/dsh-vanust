...
the twenty-seven records under `docs/adrs/` — fifteen decisions in force, two proposed
decisions awaiting a human (0026, 0027), nine approval records, and the superseded ADR 0007. Two
tools read it —
