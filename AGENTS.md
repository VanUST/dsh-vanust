...
the twenty-four records under `docs/adrs/` — fourteen decisions in force, one proposed
decision awaiting a human, eight approval records, and the superseded ADR 0007. Two
tools read it —
