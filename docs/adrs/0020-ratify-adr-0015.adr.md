---
id: "0020"
title: Ratify ADR 0015
type: approval
status: active
author:
  authority: human
  name: human
created: 2026-09-15T12:22:21.487Z
source:
  kind: file
  path: docs/ratchet/sources/2026-09-15-ratification-0015.md
  hash: sha256:3b199a47aecd8bd4b14068912f7244c3041cbcb97b72a8ca5067650780a6cce3
zones: []
laws: []
supersedes: []
approves:
...
ratification:
  ...
  targets:
    - id: "0015"
      contentHash: sha256:2eff3f97e59281b938a44557382f7b4d3e024e08a5ac2d5b261cbe3edfba2c52
---

## Context

- ADR 0015 — The grill session consents through the same question channel (docs/adrs/0015-the-grill-session-consents-through-the-question-channel.adr.md)
...
and selected **Approve** for it. ADR 0015 is ratified at the content hashes recorded in
the frontmatter above and now contributes law.

The laws brought into force:

- `shipped-plugins.the-grill-entry-triggers-the-one-question-and-accepts-no-answer` — The grill session's consent entry puts the ratchet's own question to the human through the one question channel and exposes no key an answer could travel in, so it is a third entry to the single channel and never a third channel. (docs/adrs/0015-the-grill-session-consents-through-the-question-channel.adr.md)
- `shipped-plugins.ingestion-ratifies-only-a-record-it-wrote` — Ingestion puts a decision to the human only after it has written it, and reports rather than mints when the record was not written, no question channel is available, or the answer cannot be read. (docs/adrs/0015-the-grill-session-consents-through-the-question-channel.adr.md)
...
derivation can be re-read at docs/ratchet/sources/2026-09-15-ratification-0015.md instead of trusted.
